...
const Header = () => {
    ...
    window.addEventListener('scroll', function () {
        ...
        // add the scroll-header class to tag with the header-tag 
            ...
            <div className={Toggle ? "nav__menu show-menu" : "nav__menu"}>
                <ul className='nav__list grid'>
                    <li className='nav__item'>
                        <a href="#home" onClick={() => setActiveNav('#home')} className={activeNav === "#home" ? "nav__link active__link" : "nav__link active__link" }>
